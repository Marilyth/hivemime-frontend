...
function useAccentColours() {
    const setCommunityAccent = (color)=>{
        // Convert hex to OKLCH if needed, or accept OKLCH directly
        document.documentElement.style.setProperty('--community-accent', color);
    };
    const resetToDefault = ()=>{
        document.documentElement.style.setProperty('--community-accent', 'var(--honey-brown)');
    };
    return {
        setCommunityAccent,
        resetToDefault
...
function RootLayout(param) {
    ...
    const accent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$accent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAccentColours"])();
...
_s(RootLayout, "0j4jv5MODOJeKN/aV6FyaUkXwTk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$accent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAccentColours"]
    ];
});
_c = RootLayout;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a761472c._.js.map