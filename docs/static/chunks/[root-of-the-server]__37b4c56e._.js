...
function ParallaxContainer(param) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "ParallaxContainer.useEffect": ()=>{
            ...
            return ({
                "ParallaxContainer.useEffect": ()=>window.removeEventListener("scroll", handleScroll)
            })["ParallaxContainer.useEffect"];
        }
    }["ParallaxContainer.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ParallaxContainer, "WzXr9uhGfXxPyY3YDt08E2OJQzY=");
...
function CombGenerator(param) {
    ...
    function generateCombs() {
        ...
        for (const gen of combs){
            ...
            console.log("Generating combs for distance ".concat(gen.distance, "... (effective height: ").concat(effectiveHeight, ", lastY: ").concat(lastY, ")"));
            // Don't render more than visible.
            for(let y = lastY + step; y < effectiveHeight + 100; y += step){
                let x = Math.random() * window.innerWidth / 2;
                if (gen.combs.length % 2 == 0) x += window.innerWidth / 2;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CombGenerator.useEffect": ()=>{
            ...
            generateCombs();
            return ({
                "CombGenerator.useEffect": ()=>ro.disconnect()
            })["CombGenerator.useEffect"];
        }
    }["CombGenerator.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CombGenerator, "DOASuwHj3ZdWZ6n0Ug36pnkayEs=");
_c2 = CombGenerator;
var _c, _c1, _c2;
...
"[project]/src/components/custom/utility/infinite-parallax-background.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function InfiniteParallaxBackground(param) {
    let { distance = 10, className = "bg-pattern blur-[3px]", style, patternHeight = 2000 // Default pattern height in pixels
     } = param;
    _s();
    const [documentHeight, setDocumentHeight] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InfiniteParallaxBackground.useEffect": ()=>{
            const updateHeight = {
                "InfiniteParallaxBackground.useEffect.updateHeight": ()=>{
            ...
            const handleResize = {
                "InfiniteParallaxBackground.useEffect.handleResize": ()=>{
                    setTimeout(updateHeight, 100); // Small delay to ensure layout is complete
                }
            }["InfiniteParallaxBackground.useEffect.handleResize"];
            window.addEventListener('resize', handleResize);
            // Update height periodically as a fallback
    ...
    // Calculate how many pattern repeats we need to cover the full document height
    // Add extra buffer to account for parallax offset and ensure full coverage
    const parallaxScale = 1 / distance;
    const effectiveDocumentHeight = documentHeight / parallaxScale;
    const bufferMultiplier = 1.5; // 50% extra buffer
    const totalHeight = Math.max(effectiveDocumentHeight * bufferMultiplier, window.innerHeight * 3);
    const patternRepeats = Math.ceil(totalHeight / patternHeight);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$custom$2f$utility$2f$parallax$2d$container$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ParallaxContainer"], {
        distance: distance,
        style: style,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            style: {
                height: "".concat(patternRepeats * patternHeight, "px"),
                backgroundSize: "auto ".concat(patternHeight, "px"),
                backgroundRepeat: 'repeat-y'
            }
        }, void 0, false, {
            fileName: "[project]/src/components/custom/utility/infinite-parallax-background.tsx",
            lineNumber: 71,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
_s(InfiniteParallaxBackground, "fLLU3KE4tECczZamMs1OQYpCOaQ=");
_c = InfiniteParallaxBackground;
var _c;
__turbopack_context__.k.register(_c, "InfiniteParallaxBackground");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$custom$2f$utility$2f$infinite$2d$parallax$2d$background$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/custom/utility/infinite-parallax-background.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarInset"], {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$custom$2f$utility$2f$infinite$2d$parallax$2d$background$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InfiniteParallaxBackground"], {
                                                            distance: 10
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/layout.tsx",
                                                            lineNumber: 81,
                                                        ...
                                                        isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            className: "flex flex-1 flex-col gap-4 py-4 z-10 min-h-10000",
                                                            children: children
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/layout.tsx",
                                                            lineNumber: 85,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37b4c56e._.js.map